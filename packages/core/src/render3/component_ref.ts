...
export class ComponentFactory<T> extends viewEngine_ComponentFactory<T> {
  ...
  create(
    ...
    try {
      ...
      // TODO: should LifecycleHooksFeature and other host features be generated by the compiler and id:431
      // executed here?
...
export class ComponentRef<T> extends viewEngine_ComponentRef<T> {
  ...
  constructor(
    ...
    /* TODO (jasonaden): This is incomplete, to be adjusted in follow-up PR. Notes from Kara:When id:375
